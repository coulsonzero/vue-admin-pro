import{_ as y,o as i,c as s,b as t,t as d,F as g,g as f,n as q,W as u,X as h,ag as m,p as v,f as C,a as _,d as G}from"./index.1f59ed38.js";const S={data:()=>({title:"Golang FAQ",faq:[{question:"slice \u548C\u6570\u7EC4\u7684\u533A\u522B ? (\u57FA\u672C\u5FC5\u95EE)",answer:`
        ...
        make: \u4EC5\u7528\u4E8E\u5206\u914D\u5185\u5B58\u548C\u521D\u59CB\u5316\u4E00\u4E2A\u5BF9\u8C61\u7C7B\u578B(slice, map, chan), \u8FD4\u56DE\u7C7B\u578B\u548C\u5B83\u7684\u7B2C\u4E00\u4E2A\u53C2\u6570\u7C7B\u578B\u76F8\u540C\u800C\u4E0D\u662F\u4E00\u4E2A\u6307\u9488\uFF0C\u8FD4\u56DE\u5F15\u7528`,difficulty:"medium"},{question:"defer \u7684\u6267\u884C\u987A\u5E8F ? (\u57FA\u672C\u5FC5\u95EE)",answer:`
    ...
    \u3000\u3000\u3000\u3000goroutine\uFF1A\u53EA\u6709\u4E09\u4E2A\u5BC4\u5B58\u5668\u7684\u503C\u4FEE\u6539 - PC / SP / DX.
        ...
        `,difficulty:"medium"}],flag:-1,diffMap:new Map([["easy","\u7B80\u5355"],["medium","\u4E2D\u7B49"],["hard","\u56F0\u96BE"]]),dialog_open:!1,question_title:"",question_answer:"",row:{data:[]}}),methods:{toggleAccordion(e){this.flag==e?this.flag=-1:this.flag=e},confirm_dialog(){this.dialog_open=!1,console.log(this.question_title),console.log(this.question_answer);let e={question:this.question_title,answer:this.question_answer,difficulty:"easy"};this.row.data.push(e),this.faq.push(e),localStorage.setItem("faq",JSON.stringify(this.row))},initFaq(){try{let e=localStorage.getItem("faq");JSON.parse(e).data.forEach(n=>this.faq.push(n))}catch{console.log("not found faq storge")}},indent(e){let o=e.split("");for(let n=0;n<o.length;n++)if(o[n]!=" ")return n*3+"px"}},mounted(){this.initFaq()}},l=e=>(v("data-v-631ff8af"),e=e(),C(),e),k={class:"container"},M={class:"accordion"},b=["id","aria-expanded","onClick"],T={class:"title-wrapper"},P={class:"accordion-title"},A=["data-difficulty"],B=l(()=>t("span",{class:"icon","aria-hidden":"true"},null,-1)),x={class:"accordion-content"},I=l(()=>t("svg",{class:"btn-svg",t:"1667228264998",viewBox:"0 0 1024 1024",version:"1.1",xmlns:"http://www.w3.org/2000/svg","p-id":"2524",width:"200",height:"200"},[t("path",{d:"M504.595826 16.451146c-278.332887 0-503.967312 225.633418-503.967312 503.967312s225.633418 503.967312 503.967312 503.967312 503.967312-225.633418 503.967312-503.967312S782.928713 16.451146 504.595826 16.451146zM827.449445 537.444735 523.428072 537.444735l0 305.826335c0 10.872079-8.768976 19.686381-19.641055 19.686381-10.873087 0-19.641055-8.814301-19.641055-19.686381l0-305.826335L181.742207 537.444735c-10.873087 0-19.686381-8.768976-19.686381-19.641055 0-10.872079 8.813294-19.641055 19.686381-19.641055l302.403755 0 0-300.598793c0-10.873087 8.767968-19.686381 19.641055-19.686381 10.872079 0 19.641055 8.813294 19.641055 19.686381l0 300.598793 304.021372 0c10.872079 0 19.686381 8.768976 19.686381 19.641055C847.135825 528.675759 838.321524 537.444735 827.449445 537.444735z","p-id":"2525"})],-1)),X=[I],F={class:"btn-dialog"},H=l(()=>t("div",{class:"dialog-title"},"Add a new Question",-1)),W={class:"dialog-container"},V=l(()=>t("svg",{t:"1667231486592",class:"icon",viewBox:"0 0 1024 1024",version:"1.1",xmlns:"http://www.w3.org/2000/svg","p-id":"3443",width:"200",height:"200"},[t("path",{d:"M512.268258 130.418417c-210.405363 0-381.581583 171.175196-381.581583 381.581583 0 210.405363 171.17622 381.580559 381.581583 381.580559s381.581583-171.17622 381.581583-381.580559c-0.001024-210.405363-171.17622-381.581583-381.581583-381.581583z m0 727.389636c-190.678164 0-345.808053-155.128866-345.808054-345.808053s155.128866-345.808053 345.808054-345.808053 345.808053 155.128866 345.808053 345.808053c0 190.678164-155.129889 345.808053-345.808053 345.808053zM652.381845 630.389812c6.984946 6.986993 6.984946 18.310141 0 25.297135a17.840178 17.840178 0 0 1-12.649079 5.238197c-4.576767 0-9.155583-1.746748-12.649079-5.238197L507.353608 535.955845 384.126962 659.182492a17.840178 17.840178 0 0 1-12.64908 5.238197c-4.576767 0-9.155583-1.746748-12.649079-5.238197-6.984946-6.986993-6.984946-18.310141 0-25.297135l123.226647-123.226647-114.671061-114.673108c-6.984946-6.986993-6.984946-18.310141 0-25.297135 6.986993-6.981874 18.310141-6.981874 25.297135 0l114.672084 114.672085 116.358424-116.358424c6.986993-6.981874 18.310141-6.981874 25.297135 0 6.984946 6.986993 6.984946 18.310141 0 25.297134L532.651767 510.65871 652.381845 630.389812z",fill:"#272636","p-id":"3444"})],-1)),L=[V],U=l(()=>t("div",{class:"copyright"},[t("div",null,[_("\xA92022 "),t("span",null,"CoulsonZero"),_(" All rights reserved")])],-1));function Q(e,o,n,N,K,c){return i(),s(g,null,[t("div",k,[t("h2",null,d(e.title),1),t("div",M,[(i(!0),s(g,null,f(e.faq,(a,r)=>(i(),s("div",{class:"accordion-item",key:r},[t("button",{id:r,"aria-expanded":r===e.flag,onClick:p=>c.toggleAccordion(r)},[t("div",T,[t("span",P,d(String(r+1).padStart(2,0)+".   "+a.question),1),t("span",{class:"accordion-difficulty","data-difficulty":a.difficulty},d(e.diffMap.get(a.difficulty)),9,A)]),B],8,b),t("div",x,[(i(!0),s(g,null,f(a.answer.split(`
`),(p,w)=>(i(),s("p",{key:w,style:q({textIndent:c.indent(p)})},d(p),5))),128))])]))),128))]),t("div",{class:"btn-add",onClick:o[0]||(o[0]=a=>e.dialog_open=!0)},X),u(t("div",{class:"dialog-wrapper",onClick:o[1]||(o[1]=a=>e.dialog_open=!1)},null,512),[[h,e.dialog_open]]),u(t("div",F,[H,t("div",W,[u(t("input",{type:"text",name:"question-title","onUpdate:modelValue":o[2]||(o[2]=a=>e.question_title=a),class:"q-title",placeholder:"Enter a question title "},null,512),[[m,e.question_title]]),u(t("textarea",{"onUpdate:modelValue":o[3]||(o[3]=a=>e.question_answer=a),class:"q-answer",placeholder:"Here is answer..."},null,512),[[m,e.question_answer]]),t("button",{class:"dialog-confirm",onClick:o[4]||(o[4]=(...a)=>c.confirm_dialog&&c.confirm_dialog(...a))},"Confirm"),t("button",{class:"dialog-cancle",onClick:o[5]||(o[5]=a=>e.dialog_open=!1)},L)])],512),[[h,e.dialog_open]])]),U],64)}const z=y(S,[["render",Q],["__scopeId","data-v-631ff8af"]]);const $={class:"faq-page"},E={__name:"FAQView",setup(e){return(o,n)=>(i(),s("div",$,[G(z)]))}},D=y(E,[["__scopeId","data-v-b39cbf11"]]);export{D as default};
